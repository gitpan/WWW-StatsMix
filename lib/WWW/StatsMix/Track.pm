package WWW::StatsMix::Track;

$WWW::StatsMix::Track::VERSION = '0.01';

use 5.006;

=head1 NAME

WWW::StatsMix::Metric - Placeholder for StatsMix Track.
